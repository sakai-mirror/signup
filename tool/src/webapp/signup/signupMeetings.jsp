				...
				<h:panelGroup rendered="#{SignupMeetingsBean.meetingsAvailable}">
				 	...
				 	<t:dataTable 
						...
						<t:column>
							...
							<h:panelGroup styleClass="itemAction" style="margin-left:2em">
							  <%--//Savitha: this resolves to a link that takes the user to the attendance view for this meeting, note the rendered conditions --%>
								<h:commandLink id="attendanceView" action="" value="Attendance"  rendered="#{wrapper.meeting.allowAttendance}"/>  <%--rendered="if ((in progress OR completed) AND attendance is a selected option for meeting) --%>
							</h:panelGroup>
						</t:column>	
